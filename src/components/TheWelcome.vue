...
<template>
  <WelcomeItem>
    <template #icon>
      <DocumentationIcon class="text-cyan-100"/>
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <ToolingIcon class="text-cyan-200"/>
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <EcosystemIcon class="text-cyan-300"/>
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <CommunityIcon class="text-cyan-400" />
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <SupportIcon class="text-cyan-500" />
    </template>
